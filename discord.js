...
connection.connect(function (err) {
    ...
    bot.on('ready', () => {
        ...
        explicit = ["lick your", "suck your", "tits", "boobs", "breasts", "fuck your"]
        ...
        bot.on('message', msg => {
            ...
            if (msg.content == "Sophie End Process" && msg.author.id == "367352445657022484") process.exit("ADMIN_TERMINATED_PROCESS");
                        ...
                        if (msg.content.toLowerCase().includes("10") || msg.content.toLowerCase().includes("11") || msg.content.toLowerCase().includes("12") || msg.content.toLowerCase().includes("13") || msg.content.toLowerCase().includes("14") || msg.content.toLowerCase().includes("15") || msg.content.toLowerCase().includes("16")) {
                            ...
                            connection.query(`SELECT * FROM pedodb WHERE ID='${msg.author.id}'`),
                                function (err, result) {
                                    ...
                                    if (result2[1].flag("Adult") || result2[1].flag("Young Adult") || result2[1].flag("Pedophile")) {
                                        msg.channel.send({
                                            embed: {
                                                color: 'e74c3c',
                                                author: {
                                        ...
                                        connection.query(`INSERT INTO pedodb(id,flag) VALUES('${msg.author.id}','Minor') ON DUPLICATE KEY UPDATE ID="${msg.author.id}", flag="Minor";`);
                                    }
                                ...
                                connection.query(`SELECT * FROM pedodb WHERE ID = "${msg.author.id}"`),
                                    function (err, result) {
                                        ...
                                        if (result.includes("Pedophile")) {
                                            ...
                                            console.log("Age Verified")
                                            connection.query(`INSERT INTO pedodb(id,flag) VALUES('${msg.author.id}','Adult') ON DUPLICATE KEY UPDATE ID="${msg.author.id}", flag="Minor";`);
                                        }
                                    })
                                }
                                    ...
                                    connection.query(`SELECT * FROM pedodb WHERE ID = "${msg.author.id}"`),
                                        function (err, result) {
                                            ...
                                            if (result.includes("Adult") || result.includes("Pedophile")) {
                                                ...
                                                connection.query(`INSERT INTO pedodb(id,flag) VALUES('${msg.author.id}','Young Adult') ON DUPLICATE KEY UPDATE ID="${msg.author.id}", flag="Minor";`);
                                            }
                                        })
                                    }
                                }
